% 2D 3x3 Square Truss Code for 25 Unit Cells 
% This code takes any 3x3 unit cell design in 2D, repeats it in a 5x5 
% square, and adds members on all outer edges.  The resultant design will 
% be more representative of continuum behavior.
% -----------------------------------------------------------------
...
r = (50*(10^-6));
%}
function [C,volFrac] = Truss_2D_3x3_25UC_AnyCase_V1(sel,r,E,tinyCA)
    % Calculated Inputs
    nucFac = 5;
    ...
    % Generate Connectivity Array for 25 UC's 
...
% FUNCTION TO GENERATE CONNECTIVITY ARRAY FOR 25 3x3 UC'S IN 5x5 SQUARE
