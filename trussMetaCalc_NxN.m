...
function [C,volFrac,totalTrussVol] = trussMetaCalc_NxN(nucFac,sel,r,E,CA)
    ...
    [volFrac,totalTrussVol] = calcVF(NC,CA,r,sel);
...
function [volFrac,totalTrussVol] = calcVF(NC,CA,r,sel)
    totalTrussVol = 0;
    for i = 1:size(CA,1)
