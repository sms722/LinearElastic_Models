...
rvar = (50*(10^-6)).*ones(1,size(CA,1)); rvar(5) = (55*(10^-6));
%}
function [C11,C22,volFrac] = fiberStiffnessModel_rVar(sel,rvar,E,CA,nucFac)
    % Calculated Inputs
    sidenum = (2*nucFac) + 1;
    ...
    C11 = fiberCalc(NC,CA,volFrac,E,1)/nucFac;
    C22 = fiberCalc(NC,CA,volFrac,E,2)/nucFac;
end
...
function Cval = fiberCalc(NC,CA,volFrac,E,dir)    
