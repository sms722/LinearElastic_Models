...
% This version uses e21 to represent shear instead of e12-- that is, the
% shearing is in the y-direction, instead of the x-direction
...
% Case 14, 1 unit cell (3x3 grid)
%CA = [1,2;2,3;3,6;6,9;8,9;7,8;4,7;1,4;1,5;5,6;5,9;5,8];

% Case 15, 1 unit cell (3x3 grid)
%CA = [1,2;2,3;3,6;6,9;8,9;7,8;4,7;1,4;1,5;4,5;5,6;2,5;5,8];

% Case 16, 1 unit cell (3x3 grid)
%CA = [1,2;2,3;3,6;6,9;8,9;7,8;4,7;1,4;1,5;5,6;5,8];

% Case 17, 1 unit cell (3x3 grid)
%CA = [1,2;2,3;3,6;6,9;8,9;7,8;4,7;1,4;5,7;4,5;5,6;2,5;5,8];

% Case ZZZ, 1 unit cell (3x3 grid)
CA = [1,2;2,3;1,4;1,5;3,6;4,5;5,6;4,9;7,8;8,9;4,7;6,9];

% Case 1, 1 unit cell (3x3 grid)
%CA = [1,2;2,3;1,4;1,5;2,5;3,5;3,6;4,5;5,6;4,7;5,7;5,8;5,9;6,9;7,8;8,9];
%{
% Case 2, 1 unit cell (3x3 grid)
...
% Case 10, 1 unit cell in 5x5 (5x5 grid)
CA = [1,2;2,3;3,4;4,5;5,10;10,15;15,20;20,25;
      25,24;24,23;23,22;22,21;16,21;11,16;6,11;1,6;
      3,8;8,13;13,18;18,23;11,12;12,13;13,14;14,15;
      1,7;2,7;3,7;6,7;7,8;7,11;7,12;7,13;
...
% Case 11, 1 unit cell in 4x4 (4x4 grid)(nonsymmetric)
CA = [1,2;2,3;3,4;4,8;8,12;12,16;15,16;14,15;13,14;9,13;5,9;1,5;
      2,6;6,10;10,14;3,7;7,11;11,15;5,6;6,7;7,8;9,10;10,11;11,12;
      1,6;2,7;3,8;5,10;6,11;7,12;9,14;10,15;11,16];

% Case 12, 1 unit cell in 4x4 (4x4 grid)(nonsymmetric)
CA = [1,2;2,3;3,4;4,8;8,12;12,16;15,16;14,15;13,14;9,13;5,9;1,5;
      2,6;6,10;10,14;3,7;7,11;11,15;5,6;6,7;7,8;9,10;10,11;11,12;
      1,6;2,7;4,7;5,10;7,10;7,12;10,13;10,15;11,16];

% Case 13, 9 unit cells in 2x2 (4x4 grid)(nonsymmetric)
CA = [1,2;2,3;3,4;4,8;8,12;12,16;15,16;14,15;13,14;9,13;5,9;1,5;
      2,6;6,10;10,14;3,7;7,11;11,15;5,6;6,7;7,8;9,10;10,11;11,12;
      1,6;2,7;3,8;5,10;6,11;7,12;9,14;10,15;11,16];

  
% Case 13, 16 unit cells in 2x2 (5x5 grid)(nonsymmetric)
CA = [1,2;2,3;3,4;4,5;5,10;10,15;15,20;20,25;24,25;23,24;22,23;21,22;
      16,21;11,16;6,11;1,6;2,7;7,12;12,17;17,22;3,8;8,13;13,18;18,23;
      4,9;9,14;14,19;19,24;6,7;7,8;8,9;9,10;11,12;12,13;13,14;14,15;
      16,17;17,18;18,19;19,20;1,7;2,8;3,9;4,10;6,12;7,13;8,14;9,15;
      11,17;12,18;13,19;14,20;16,22;17,23;18,24;19,25];
%}
...
function [C,uBasket,FBasket] = generateC(sel,r,NC,CA,A,E,C)
    ...
    %       solve for all unknowns
        e11 = strainvec(1); e22 = strainvec(2); e21 = strainvec(3);
        ...
        else % when testing non-zero e21
            K = formK(NC,CA,A,E); % function for this below
            u_r = []; F_q = []; qvec = []; rvec = [];
            % Assigning Force/Displacement BCs for different nodes/DOFs
            for x = 1:1:size(NC,1) % looping through nodes by coordinate
                ...
                (ismember(ND(x,2),[0,1]) == true)
                    ...
                    % Finding y-DOF
                    if ND(x,2) == 0
                        % displacement in y is proportional to x-coordinate
                        % (due to nature of shear)
                        u_r = [u_r;(e21*sel*ND(x,1))];
                        rvec = [rvec,(2*x)];
                    elseif ND(x,2) == 1
    ...
    %       stress vector [s11,s22,s12]'
        F_x = 0; F_y = 0; F_yx = 0;
        for n = 1:1:size(Fi_yx,2)
            F_x = F_x + F(Fi_x(n));
            F_y = F_y + F(Fi_y(n));
            F_yx = F_yx + F(Fi_yx(n));
        end
        stressvec = (1/(sel*2*r)).*[F_x;F_y;F_yx];
