...
%       for center node
    ...
    u(11) = e11*sel;
    %--% THE FOLLOWING IS ONLY true for a fully-populated-and-symmetric 
    %--% unit cell:
    u(9) = sel.*((e11*0.5)+e12); u(13) = sel.*((e12*0.5)+e11);
    u(10) = sel*e22; u(14) = sel*e22*0.5;
    u(3) = u(13)-(sel*e11); u(7) = u(9)-(sel*e12);
    u(4) = u(14); u(8) = u(10)-(sel*e22);
    %--% TBD: HOW TO CODE/FIND u(3),u(4),u(7),u(8),u(9),u(10),u(13),and 
    %--% u(14) for a not-fully-populated-and-symmetric unit cell
    
%   develop force vector for all nodes (except center node) using sized-down K
%       matrix
    Knew = K([1:8,11:18],[1:8,11:18]); 
    F = Knew*u;
